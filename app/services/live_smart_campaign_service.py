...
def create_live_campaign(
    db: Session, max_symbols: int, entry_amount: float, feature_version: str = "v1"
) -> dict:
    ...
    c = LiveSmartCampaign(max_symbols=max_symbols, entry_amount_usdt=entry_amount, feature_version=feature_version)
    db.add(c)
    db.flush()
